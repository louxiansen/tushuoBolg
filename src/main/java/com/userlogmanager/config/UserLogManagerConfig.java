package com.userlogmanager.config;
 ...
 */
@Configuration
@ComponentScan("com.userlogmanager")
@EnableTransactionManagement
public class UserLogManagerConfig implements EnvironmentAware{
    ...
    public LocalSessionFactoryBean getSessionFactory(DataSource dataSource) {
        ...
        lsf.setPackagesToScan("com.userlogmanager.entity");
        return lsf;
    }
